    ...
    get dataTooltip() {
        ...
        switch (this.data.id) {
            ...
            case 'reaction':
                ...
                break;
            case 'feature':
                desc = `<div class="custom-tooltip content"><h4 class="title" style="--data-color:${this.data.color}"><i class="fas ${this.data.symbol}"></i>Feature<i class="fas ${this.data.symbol}"></i></h4><p class="notes"><i>Left Click to highlight items of type feature.</i></p><p class="notes"><i>Right Click to grey out.</i></p></div>`; 
                break;
            case 'spell':
            ...
            default:
                desc = this.data.custom?.tooltip ? `
                    <div class="custom-tooltip content">
                        <div class="header">
                            <h4 class="title" style="--data-color:${this.data.color}">${this.data.custom?.tooltip?.label}</h4>
